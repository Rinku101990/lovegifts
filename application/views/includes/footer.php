<footer class="myfooter footer-sub"> <!--footer start -->
	<div class="container">
    	<div class="row vdivide">
			...
			<div class="col-md-2 widget">
                ...
                <article class="widget_content">
    				<table>
                        <tr>
                            <td><a href="<?php echo base_url('contacts');?>">Contact Us</a></td>
                        </tr>
    					<tr>
                            <td><a href="<?php echo base_url('track');?>">Track Order </a></td>
                        </tr>
                        <tr>
                            <td><a href="<?php echo base_url('terms');?>">Terms</a></td>
                        </tr>
                        <tr>
                            <td><a href="<?php echo base_url('disclaimer');?>">Disclaimer</a></td>
                        </tr>
                        <tr>
                            <td><a href="<?php echo base_url('privacy');?>">Privacy</a></td>
                        </tr>
                        <tr>
                            <td><a href="<?php echo base_url('faq');?>">FAQ </a></td>
                        </tr>
                    </table>       
                </article>
    		</div>
