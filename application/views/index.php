              		...
              		<h3 class="mt-4 textdecorationheader"><?php echo $productslist->pro_title;?></h3><hr>
              			<div class="separator-2"></div>
			   				<div class="inner-info">
								...
								<?php if(($productslist->pro_description)!='' && ($productslist->pro_required_picture)!=''){ ?>	
                        		<h5><?php $desc = $productslist->pro_description.' '.$productslist->pro_required_picture; echo substr($desc, 0, 57);?></h5><hr>
								<?php }else if(($productslist->pro_description)=='' && ($productslist->pro_required_picture)!=''){ ?>
									<h5><?php $desc = $productslist->pro_required_picture; echo $desc;?></h5><hr>
								<?php }else if(($productslist->pro_description)!='' && ($productslist->pro_required_picture)==''){ ?>
									<h5><?php $desc = $productslist->pro_description; echo substr($desc, 0, 57);?></h5><hr>
								<?php }else{ ?>
								<?php } ?>
